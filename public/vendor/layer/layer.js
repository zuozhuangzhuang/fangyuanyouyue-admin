...
//拖拽层
    Class.pt.move = function () {
        var that = this,
            ...
            resizeElem = layero.find('.layui-layer-resize'), dict = {};
...
//相册层
    layer.photos = function (options, loop, key) {
        ...
        // 做了兼容admui项目的适配
        var iframeWin = typeof $.content.window !== 'undefined' ? $.content.window() : window;
        var type = options.photos.constructor === iframeWin.Object;
