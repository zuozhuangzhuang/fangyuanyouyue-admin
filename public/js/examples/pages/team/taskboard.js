...
(function (document, window, $) {
    ...
    var taskboard = {
        ...
        taskTpl: function (data) {
            return '<li class="list-group-item priority-' + data.priority + '" data-taskboard="slidePanel" data-url="/public/data/examples/pages/taskboard-panel.tpl">' +
        ...
        init: function () {
            var self = this;
            $.getJSON($.ctx + '/public/data/examples/pages/taskboard.json', function (data) {
        ...
        initSortable: function () { //Sortable
        ...
        handleDeleteStage: function () {
            $(document).on('click', '.taskboard-stage-delete', function () {
                ...
                parent.layer.alert("您确定要删除吗？", {icon: 4}, function (index) {
        ...
        initStageDropdown: function () { //Stage Dropdown
        ...
        handleDeleteTask: function () {
            $(document).on('click', '.taskboard-task-delete', function () {
                ...
                parent.layer.alert("确定要删除此任务吗？", function(index){
        ...
        handlSlidePanelPlugin: function () { //Init SlidePanel
        ...
        handleSelective: function ($target, selected) { //SlidePanel Section Handle
            var self = this;
        ...
        handleSubtasks: function () {
            ...
            $(document).on('click', '.subtask-editor-delete', function () {
                ...
                parent.layer.alert("确定要删除子任务吗？", function(_index){
        ...
        dataDelete: function ($target, name, index) { //Data
            if (index) {
